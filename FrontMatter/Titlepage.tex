...
\begin{figure}[ht]
    \centering
    \raisebox{-0.5\height}{\includegraphics[width=3.0cm]{Assets/Logo_ESI_SBA.png}}
    \hspace{1.5cm}
    \raisebox{-0.5\height}{\includegraphics[width=5.0cm]{Assets/irisa.jpg}}
    \hspace{1.5cm}
    \raisebox{-0.5\height}{\includegraphics[width=3.5cm]{Assets/cnrs-logo.jpg}}
\end{figure}
