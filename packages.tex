...
% Note: inputenc is not needed with XeLaTeX/LuaLaTeX
...
% Bibliography
\usepackage[backend=biber,style=alphabetic-verb,sorting=nyt]{biblatex} % Bibliography support with author-year style
\addbibresource{Bibliography/bibliography.bib}    % Path to the bibliography file
